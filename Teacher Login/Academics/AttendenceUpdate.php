...
<head>
    ...
    <title>Attendence Updation Page</title>
</head>
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <?php
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <a class="btn btn-warning btn-block" role="button" href="Attendence.php">Cancel</a>
                                                        </div>
                                                    </div>
                                                    </td>
                                                <?php } 
                                                ...
                                                ?>
                                                        ...
                                                        <td><?php echo (@$res['Percentage']!=null)? $res['Percentage'] : "-"; ?></td>
